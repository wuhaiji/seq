...
public class Tuple4<T1, T2, T3, T4> implements Tuple {
    ...
    public static <T1, T2, T3, T4> io.whj.seq.Tuple4<T1, T2, T3, T4> of(T1 t1, T2 t2, T3 t3, T4 t4) {
        return new io.whj.seq.Tuple4<>(t1, t2, t3, t4);
    }
    ...
    public boolean equals(Object o) {
        ...
        io.whj.seq.Tuple4<?, ?, ?, ?> tuple = (io.whj.seq.Tuple4<?, ?, ?, ?>) o;
