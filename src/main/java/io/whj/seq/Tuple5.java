...
public class Tuple5<T1, T2, T3, T4, T5> implements Tuple {
    ...
    public static <T1, T2, T3, T4, T5> io.whj.seq.Tuple5<T1, T2, T3, T4, T5> of(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5) {
        return new io.whj.seq.Tuple5<>(_1, _2, _3, _4, _5);
    }
    ...
    public boolean equals(Object o) {
        ...
        io.whj.seq.Tuple5<?, ?, ?, ?, ?> tuple = (io.whj.seq.Tuple5<?, ?, ?, ?, ?>) o;
