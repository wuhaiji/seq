...
public class Tuple6<T1, T2, T3, T4, T5, T6> implements Tuple {
    ...
    public static <T1, T2, T3, T4, T5, T6> io.whj.seq.Tuple6<T1, T2, T3, T4, T5, T6> of(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6) {
        return new io.whj.seq.Tuple6<>(_1, _2, _3, _4, _5, _6);
    }
    ...
    public boolean equals(Object o) {
        ...
        io.whj.seq.Tuple6<?, ?, ?, ?, ?, ?> tuple = (io.whj.seq.Tuple6<?, ?, ?, ?, ?, ?>) o;
